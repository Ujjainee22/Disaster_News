...
export default function Page() {
  ...
  <div className={styles.pageWrapper}>
    ...
    <div className={styles.imageBackground}>
      ...
      <ul>
      <li><b>Emergency Kit :</b> Always have a survival kit with essentials like water, non-perishable food, flashlight, whistle, batteries, first-aid supplies, and important documents.</li>
